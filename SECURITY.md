...
请不要通过公开 Issue 披露尚未修复的漏洞。优先使用当前 GitHub 仓库的
[Private vulnerability reporting](https://github.com/1132475063qq-a11y/infinite-canvas-short-drama/security/advisories/new)。
